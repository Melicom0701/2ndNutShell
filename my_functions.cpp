...
void khung(){
    ...
    SetConsoleOutputCP(CP_UTF8);
 	setcolor(0,11);
 	printf("\n%9c",201);
 	for (i=0;i<=85;i++) printf("%c",196);
    printf("\n\n\n");
    printf("\t\t\t\t-----------------------------------------------------\n");
    printf("\t\t\t\t-        PBL-1 Du an lap trinh tinh toan            -\n");
    printf("\t\t\t\t- Giao vien huong dan : Ths. Nguyen Van Nguyen      -\n");
    printf("\t\t\t\t- Sinh vien    : Nguyen Hoang Nhat Linh             -\n");
    printf("\t\t\t\t- Sinh vien    : Ho Tran Thi Hong Vy                -\n");
    printf("\t\t\t\t- Sinh vien    : Le Duy Phuong Ha                   -\n");
    printf("\t\t\t\t-----------------------------------------------------\n");
}
...
//        printf("\t\t\t\t----------------------------------------------\n");
//        printf("\t\t\t\t-     PBL-1 Du an lap trinh tinh toan        -\n");
//        printf("\t\t\t\t- GV huong dan : Ths. Nguyen Van Nguyen      -\n");
//        printf("\t\t\t\t- Sinh vien    : Nguyen Hoang Nhat Linh      -\n");
//        printf("\t\t\t\t- Sinh vien    : Ho Tran Thi Hong Vy         -\n");
//        printf("\t\t\t\t- Sinh vien    : Le Duy Phuong Ha            -\n");
//        printf("\t\t\t\t----------------------------------------------\n");
       ...
       // khung();
        ...
        setConsoleColor(15);  // Set console color to white
        printf("\n\n\n");
        printf("\t\t\t\t----------------------------------------------\n");
        ...
        {
            case 1:
                isEulerHandling(n, graph, deg);
                break;

            case 2:
                dijkstraHandling(n, graph, path);
                break;

            case 3:
                primHandling(n, graph);
                break;
